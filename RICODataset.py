...
Original file is located at
    https://colab.research.google.com/drive/1tnWptpQFCkEv7A9bHoikUQ9vn3alDT7H

**[NOT DONE]** Necessary imports for class construction
"""
...
"""RICOFullDataset class on all element from the given dataframe.

Used to parse data in a simple manner. Also implements functions to manage exporting the dataset to appropriate file types.
"""
